...
This is the 1995 NBA's Collective Bargaining Agreement (CBA) which has been converted to a text file, then broken up by Article and Exhibit to .Rmd files which then serves as the basis for this bookdown site. The original version of the 1995 CBA can be found on my Github website [atlhawksfanatic.github.io](https://atlhawksfanatic.github.io/) ([here](https://github.com/atlhawksfanatic/atlhawksfanatic.github.io/raw/master/research/CBA/1995-NBA-NBPA-Collective-Bargaining-Agreement.pdf)) 

The purpose of this site is three-fold:

1. to allow historical documentation of previous collective bargaining agreements of the NBA;
